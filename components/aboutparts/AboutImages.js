        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8">
               <h4 className="text-[#E3510F] font-bold text-2xl mb-3 uppercase tracking-wider" style={{ fontFamily:'var(--font-display)' }}>Our Corporate Identity</h4>
               <p className="text-[#ADBAC7] text-base font-medium leading-relaxed">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
            <div className="absolute bottom-8 left-8 right-8">
               <h4 className="text-[#E3510F] font-bold text-2xl mb-3 uppercase tracking-wider" style={{ fontFamily:'var(--font-display)' }}>Heritage & Innovation</h4>
               <p className="text-[#ADBAC7] text-base font-medium leading-relaxed">
