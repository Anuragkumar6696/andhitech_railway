...
// FIX: Safe fetch helper — sends Accept: application/json so Next.js RSC
// middleware never intercepts this as an RSC navigation request, and checks
// Content-Type before parsing so raw RSC/HTML text never leaks into state.
