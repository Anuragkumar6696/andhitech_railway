      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
        ...
        <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }} transition={{ duration:1 }}
          ...
          <div className="absolute bottom-10 left-10 right-10 lg:right-8 glass-card p-6">
            <div className="text-[#E3510F] text-[10px] uppercase tracking-[0.2em] mb-2 font-medium" style={{fontFamily:'var(--font-mono)'}}>Join Our Team</div>
            <div className="text-[#F0F2F5] font-bold text-lg mb-1" style={{fontFamily:'var(--font-display)'}}>We&apos;re always hiring talent</div>
