...
function StepCard({ step, index, isActive, onClick }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[.65rem] mb-5 uppercase tracking-widest transition-colors duration-300 font-medium"
        style={{ fontFamily: 'var(--font-mono)', color: isActive ? color : '#AAB4C3' }}>
        {subtitle}
      </p>

      <p className={`text-[.85rem] leading-relaxed mb-7 transition-all duration-500 font-light ${isActive ? 'text-[#8C98AA]' : 'text-[#2E3848]'}`}>
        {text}
      </p>
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24 items-end">
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: .14, duration: .75, ease }}
            ...
            <p className="text-[#8C98AA] leading-relaxed text-[1.05rem] font-light">
