    ...
    <>
      ...
      >
        ...
        <motion.div style={{ y: yBg, scale }} className="absolute inset-0 z-0">
          <video
            ...
            className={`w-full h-full object-cover transition-opacity duration-[2.5s] ${ready ? 'opacity-85' : 'opacity-0'}`}
          >
            <source
      ...
      <div ref={trainRef} style={{ height: '240vh', position: 'relative' }}>
        <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden', background: '#030405' }}>
          ...
          >
            <motion.p
              style={{ fontFamily: 'var(--font-mono)', fontSize: '.80rem', letterSpacing: '.32em', textTransform: 'uppercase', color: '#E3510F' }}
              className="mb-6"
            >
