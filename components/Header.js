...
// FIX: Safe fetch helper that:
// 1. Sends Accept: application/json so Next.js RSC middleware never
//    intercepts this as an RSC navigation and returns RSC headers as body text.
// 2. Checks r.ok before parsing, so a bad response never reaches setState.
