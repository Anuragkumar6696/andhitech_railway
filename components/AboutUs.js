...
import { CheckCircle2, ArrowRight, Award, Users, Wrench, Globe } from 'lucide-react';
...
export default function AboutUs() {
  return (
    <section className="relative overflow-hidden section-gap" style={{ background:'#0F1420' }}>
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block" style={{
        background:'linear-gradient(115deg,transparent 55%,rgba(227,81,15,.03) 55%,rgba(227,81,15,.03) 100%)',
      }}/>
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-28 items-center">
          ...
          >
            {/* Main image */}
            <div className="rounded-2xl overflow-hidden border border-white/[.05] relative group">
              <Image
                src="/images/aboutback.jpg"
                alt="AND Hitech Engineering Facility"
                width={620} height={480}
                className="w-full object-cover opacity-65 group-hover:opacity-85 group-hover:scale-[1.03] transition-all duration-700"
                style={{ height:480 }}
              />
              {/* Gradient */}
              ...
              <div className="absolute bottom-6 left-7 right-7">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#8C98AA] text-[.7rem]" style={{ fontFamily:'var(--font-mono)' }}>Manufacturing Excellence Since 2013</span>
                </div>
              </div>
            </div>

            {/* Overlapping secondary image */}
            <div className="absolute -bottom-10 -right-10 w-[52%] rounded-2xl overflow-hidden border-4 border-[#0F1420] shadow-2xl hidden md:block">
              <Image
            ...
            {/* Years badge */}
            <div className="absolute -top-6 -left-6 hidden md:flex flex-col items-center justify-center text-white z-10"
              ...
              <span className="text-[.52rem] uppercase tracking-wider opacity-80 mt-0.5" style={{ fontFamily:'var(--font-mono)' }}>Years</span>
            </div>

            {/* Grid accent */}
            <div className="absolute inset-0 rounded-2xl bg-grid opacity-15 pointer-events-none"/>
          </motion.div>
          ...
          <div className="space-y-9">
            ...
            >
              {features.map((f, i) => (
                <div key={i} className="flex items-center gap-3 py-3.5 px-5 rounded-xl border border-white/[.05] hover:border-[#E3510F]/22 transition-all duration-400 group cursor-default"
